...
`),u=r.map(function(d){return function(p,v,m){m===void 0&&(m=!1);var g="";g+=m?Iu(p):Gn(p);var b=p.shapeInfo.logicalShape,x=v.logicalShape;return b.length<=x.length&&(g+=m?function(y,w){var _,k=y.name,I=k.charAt(0).toUpperCase()+k.slice(1),S="get"+I+"AtOutCoords",R=y.shapeInfo.logicalShape.length,F=w.logicalShape.length,T=jt(y.shapeInfo.logicalShape,w.logicalShape),L=Ce(F),O=F-R,B=["x","y","z","w","u","v"];_=R===0?"":F<2&&T.length>=1?"coords = 0;":T.map(function(te){return"coords."+B[te+O]+" = 0;"}).join(`
...
`)}function Gn(r){var t=r.shapeInfo.logicalShape;switch(t.length){case 0:return function(e){var n=e.name,o="get"+n.charAt(0).toUpperCase()+n.slice(1);if(e.shapeInfo.isUniform)return"float "+o+"() {return "+n+";}";var i=e.shapeInfo.texShape,a=i[0],s=i[1];if(a===1&&s===1)return`
      float `+o+`() {
  ...
  `}var c=rn(n),l=c.newShape,h=c.keptDims,f=l;if(f.length<n.length){var d=qn(e,f);return`
      `+Gn(d)+`
      float `+i+`(int row, int col) {
        return `+i+"("+jn(["row","col"],h)+`);
      }
...
`}(r);case 3:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,i="get"+o.charAt(0).toUpperCase()+o.slice(1),a=n[1]*n[2],s=n[2],u=rn(n),c=u.newShape,l=u.keptDims,h=c;if(h.length<n.length){var f=qn(e,h);return`
        `+Gn(f)+`
        float `+i+`(int row, int col, int depth) {
          return `+i+"("+jn(["row","col","depth"],l)+`);
        }
      `}if(e.shapeInfo.isUniform)return`
      float `+i+`(int row, int col, int depth) {
  ...
  `}(r);case 4:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,i="get"+o.charAt(0).toUpperCase()+o.slice(1),a=n[3],s=n[2]*a,u=n[1]*s,c=rn(n),l=c.newShape,h=c.keptDims;if(l.length<n.length){var f=qn(e,l);return`
      `+Gn(f)+`
      float `+i+`(int row, int col, int depth, int depth2) {
        return `+i+"("+jn(["row","col","depth","depth2"],h)+`);
      }
    `}if(e.shapeInfo.isUniform)return`
      float `+i+`(int row, int col, int depth, int depth2) {
  ...
  `}(r);case 5:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,i="get"+o.charAt(0).toUpperCase()+o.slice(1),a=n[4],s=n[3]*a,u=n[2]*s,c=n[1]*u,l=rn(n),h=l.newShape,f=l.keptDims;if(h.length<n.length){var d=qn(e,h);return`
      `+Gn(d)+`
      float `+i+`(int row, int col, int depth, int depth2, int depth3) {
        return `+i+"("+jn(["row","col","depth","depth2","depth3"],f)+`);
      }
    `}if(e.shapeInfo.isUniform)return`
      float `+i+`(int row, int col, int depth, int depth2, int depth3) {
        float index = dot(
  ...
  `}(r);case 6:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,i="get"+o.charAt(0).toUpperCase()+o.slice(1),a=rn(n),s=a.newShape,u=a.keptDims;if(s.length<n.length){var c=qn(e,s);return`
      `+Gn(c)+`
      float `+i+`(int row, int col, int depth,
                    int depth2, int depth3, int depth4) {
        return `+i+"("+jn(["row","col","depth","depth2","depth3","depth4"],u)+`);
      }
  ...
  `}(r);case 3:return function(o){var i=o.shapeInfo.logicalShape,a=o.name,s="get"+a.charAt(0).toUpperCase()+a.slice(1),u=o.shapeInfo.texShape,c=[Math.ceil(u[0]/2),Math.ceil(u[1]/2)];if(i[0]===1){var l=i.slice(1),h=qn(o,l);return`
        `+Iu(h)+`
...
`,Kt=function(r,t,e,n){n===void 0&&(n=!1),this.variableNames=["A","B"],this.supportsBroadcasting=!0,this.packedInputs=!0,this.packedOutput=!0,this.outputShape=ce(t,e);var o=this.outputShape.length,i="";if(n)if(o===0||J(this.outputShape)===1)i=`
    ...
    `},nd=function(r){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!0,this.outPackingScheme=hr.DENSE;var t=fr(r),e=$e();this.outputShape=r,this.userCode=`
      ivec3 outCoordsFromFlatIndex(int index) {
        `+kn(["r","c","d"],r)+`
        return ivec3(r, c, d);
      }
