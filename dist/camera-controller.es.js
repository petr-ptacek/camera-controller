...
Object.freeze({ shuffle: y, clamp: x, nearestLargerEven: b, sum: w, randUniform: function(t2, e2) {
  var n2 = Math.random();
...
var ct = function() {
  ...
  return t2.prototype.logKernelProfile = function(t3, e2, n2, r2, o2, a2) {
    var i2 = typeof r2 == "number" ? N(r2 + "ms", 9) : r2.error, s2 = N(t3, 25), u2 = e2.rank, c2 = e2.size, l2 = N(e2.shape.toString(), 14), h2 = "";
    for (var f2 in o2) {
...
function dt(t2, e2, n2, r2) {
  var o2 = $(e2), a2 = function(t3, e3, n3, r3) {
    var o3 = k(e3), a3 = r3[r3.length - 1], i3 = new Array(a3).fill(0), s3 = e3.length, u3 = n3 === "complex64" ? mt(t3) : t3;
    if (s3 > 1)
    ...
    if (c2 === 0) {
      return r3 === "complex64" ? [pt(mt(e3)[0], 0, r3)] : r3 === "bool" ? [vt(e3[0])] : [e3[0].toString()];
    }
    if (c2 === 1) {
      if (u3 > lt) {
        var l2 = ht * s3, h2 = Array.from(e3.slice(0, l2)), f2 = Array.from(e3.slice((u3 - ht) * s3, u3 * s3));
        return r3 === "complex64" && (h2 = mt(h2), f2 = mt(f2)), ["[" + h2.map(function(t4, e4) {
          return pt(t4, a3[e4], r3);
        }).join(", ") + ", ..., " + f2.map(function(t4, e4) {
          return pt(t4, a3[u3 - ht + e4], r3);
        }).join(", ") + "]"];
      }
      return ["[" + (r3 === "complex64" ? mt(e3) : Array.from(e3)).map(function(t4, e4) {
        return pt(t4, a3[e4], r3);
      }).join(", ") + "]"];
    }
    ...
    if (u3 > lt) {
      ...
      for (g2 = u3 - ht; g2 < u3; g2++) {
        y2 = (x2 = g2 * v) + v;
        m.push.apply(m, t3(e3.slice(x2, y2), d2, r3, p2, a3, g2 === u3 - 1));
      }
    } else
      for (g2 = 0; g2 < u3; g2++) {
        var x2;
...
var wt = function() {
  ...
  return t2.prototype.flatten = function() {
    ...
    return e2 === void 0 && (e2 = 0), xt.pad(this, t3, e2);
    ...
    return o2 === void 0 && (o2 = 1e-3), this.throwIfDisposed(), xt.batchNorm(this, t3, e2, n2, r2, o2);
...
var Ot;
Object.freeze({ makeTypesMatch: Nt, assertTypesMatch: Ft, isTensorInList: function(t2, e2) {
...
var Bt = function() {
  ...
  return t2.prototype.ready = function() {
    ...
    return f2 = g2 != null ? function() {
      var t4 = u2.backend.numDataIds();
      m = g2.kernelFunc({ inputs: e2, attrs: o2, backend: u2.backend });
    ...
    s2 != null && (r2 = s2.gradFunc), r2 != null && (i2.gradient = function(t4) {
...
function Qt(t2, e2) {
  ...
  return i().getNumber("WEBGL_VERSION") === 2 ? (n2 = f2.R32F, r2 = f2.R16F, o2 = f2.RGBA16F, a2 = f2.RGBA32F, s2 = f2.RED, u2 = 4, c2 = 1, l2 = f2.HALF_FLOAT, h2 = f2.FLOAT) : (n2 = t2.RGBA, r2 = t2.RGBA, o2 = t2.RGBA, a2 = f2.RGBA, s2 = t2.RGBA, u2 = 4, c2 = 4, l2 = e2 != null ? e2.HALF_FLOAT_OES : null, h2 = t2.FLOAT), { internalFormatFloat: n2, internalFormatHalfFloat: r2, internalFormatPackedHalfFloat: o2, internalFormatPackedFloat: a2, textureFormatFloat: s2, downloadTextureFormat: t2.RGBA, downloadUnpackNumChannels: u2, defaultNumChannels: c2, textureTypeHalfFloat: l2, textureTypeFloat: h2 };
}
...
function Te(t2) {
  var e2 = [1, 1, 1];
  return t2.length === 0 || t2.length === 1 && t2[0] === 1 || (e2 = [Ae(t2)].concat(De(t2))), e2;
}
function Ne(t2, e2) {
  var n2;
  e2 === void 0 && (e2 = false);
...
var nr = er(function(t2) {
  ...
  !function(e2, n2) {
    ...
    function f2(t3, h3, f3) {
      ...
      }((h3 = h3 == 1 ? { entropy: true } : h3 || {}).entropy ? [t3, m(e2)] : t3 == null ? function() {
        try {
          var t4;
          ...
          return [+new Date(), o2, i3, o2.screen, m(e2)];
        }
...
function dr(t2, e2, n2) {
  return e2 === void 0 && (e2 = "float32"), e2 = e2 || "float32", nt(t2), new gt(t2, e2, n2);
}
function pr(t2, e2) {
...
var vr = An({ batchToSpaceND_: function(t2, e2, n2) {
  ...
  return s2.length === 0 ? n2.clone() : Lt.runKernelFunc(function(t3) {
  ...
  n2 === void 0 && (n2 = "NHWC");
  var r2 = mn(t2, "x", "depthToSpace"), o2 = n2 === "NHWC" ? r2.shape[1] : r2.shape[2], a2 = n2 === "NHWC" ? r2.shape[2] : r2.shape[3], i2 = n2 === "NHWC" ? r2.shape[3] : r2.shape[1];
...
Object.freeze({ prepareAndValidate: jr });
var Yr = 30;
function $r(t2) {
...
Object.freeze({ validateUpdateShape: Qr, validateInput: Jr, calculateShapes: Zr });
...
Object.freeze({ assertParamsValid: eo, maskToAxes: no, computeOutShape: ro, startForAxis: oo, stopForAxis: ao, isSliceContinous: io, computeFlatOffset: so });
function po(t2, e2) {
  C(X(t2), function() {
...
function So(t2, e2, n2, r2, o2, a2, i2, s2) {
  ...
  var d2, p2 = e2[0], v = e2[1], m = e2[3], g2 = To(n2), y2 = g2[0], x2 = g2[1], b2 = To(r2), w2 = b2[0], E2 = b2[1], R2 = Fo(p2, w2), I2 = Fo(v, E2), k2 = function(t3, e3, n3, r3, o3, a3, i3, s3) {
    ...
    if (typeof t3 == "number") {
      ...
      u3 = { top: p3, bottom: v2, left: m2, right: d3 - m2, type: "SAME" };
    } else {
      if (t3 !== "valid")
...
function Ao(t2, e2, n2, r2, o2, a2, i2, s2) {
  ...
  var p2, v = e2[0], m = e2[1], g2 = e2[2], y2 = e2[4], x2 = No(n2), b2 = x2[0], w2 = x2[1], E2 = x2[2], R2 = No(r2), I2 = R2[0], k2 = R2[1], S2 = R2[2], D2 = Fo(v, I2), T2 = Fo(m, k2), N2 = Fo(g2, S2), F2 = function(t3, e3, n3, r3, o3, a3, i3, s3, u3, c3, l3) {
    var h3, f3, d3, p3;
    if (typeof t3 == "number") {
      h3 = { top: t3, bottom: t3, left: t3, right: t3, front: t3, back: t3, type: t3 === 0 ? "VALID" : "NUMBER" };
      var v2 = function(t4, e4, n4, r4, o4, a4) {
        o4 == null && (o4 = Do(t4, e4, r4));
      ...
      var m2 = (f3 - 1) * o3 + s3 - e3, g3 = (d3 - 1) * a3 + u3 - n3, y3 = (p3 - 1) * i3 + c3 - r3, x3 = Math.floor(m2 / 2), b3 = m2 - x3, w3 = Math.floor(g3 / 2), E3 = g3 - w3, R3 = Math.floor(y3 / 2);
  ...
  return i2 === "channelsFirst" ? p2 = [c2, P2, O2, M2, B2] : i2 === "channelsLast" && (p2 = [c2, O2, M2, B2, P2]), { batchSize: c2, dataFormat: i2, inDepth: l2, inHeight: h2, inWidth: f2, inChannels: d2, outDepth: O2, outHeight: M2, outWidth: B2, outChannels: P2, padInfo: _2, strideDepth: b2, strideHeight: w2, strideWidth: E2, filterDepth: v, filterHeight: m, filterWidth: g2, effectiveFilterDepth: D2, effectiveFilterHeight: T2, effectiveFilterWidth: N2, dilationDepth: I2, dilationHeight: k2, dilationWidth: S2, inShape: t2, outShape: p2, filterShape: e2 };
}
...
function Yo(t2, e2, n2, r2, o2, a2, i2, s2) {
  ...
  for (var u2 = Array.from(e2).map(function(t3, e3) {
    ...
    f2.suppressBeginIndex = l2.length, m || (f2.score === d2 ? (l2.push(p2), h2.push(f2.score)) : f2.score > o2 && qo(u2, f2, Jo));
  }
  var x2 = l2.length;
...
function $o(t2, e2, n2) {
  ...
  if (d2 <= 0 || p2 <= 0)
    return 0;
  var v = Math.max(a2, c2), m = Math.max(i2, l2), g2 = Math.min(s2, h2), y2 = Math.min(u2, f2), x2 = Math.max(g2 - v, 0) * Math.max(y2 - m, 0);
  return x2 / (d2 + p2 - x2);
}
function Qo(t2, e2, n2) {
...
function ea(t2, e2, n2, r2, o2) {
  for (var a2 = e2[e2.length - 1], i2 = [t2.length / a2, a2], s2 = i2[0], u2 = i2[1], c2 = B(n2, s2 * r2), l2 = B("int32", s2 * r2), h2 = 0; h2 < s2; h2++) {
    ...
    for (v = 0; v < r2; v++)
      g2[v] = p2[v].value, y2[v] = p2[v].index;
  }
  var x2 = e2.slice();
      ...
      o3.length <= a3.length && (r3 += n3 ? function(t5, e4) {
        ...
        if (i3 !== 1 || p2 || v) {
          if (p2 && !v)
            ...
            var m = i3 - 2, g2 = i3 - 1;
            u3.indexOf(m) > -1 && u3.indexOf(g2) > -1 ? d2 = "return vec4(outputValue.x);" : u3.indexOf(m) > -1 ? d2 = "return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);" : u3.indexOf(g2) > -1 && (d2 = "return vec4(outputValue.xx, outputValue.zz);");
          }
        } else
...
var Ra = function(t2, e2, n2, r2) {
  ...
  var i2 = "0.0";
  r2 != null && (Ro(t2, r2), this.variableNames.push("offset"), i2 = "getOffsetAtOutCoords()");
  var s2 = "1.0";
  o2 != null && (Ro(t2, o2), this.variableNames.push("scale"), s2 = "getScaleAtOutCoords()"), this.outputShape = t2, this.userCode = "\n      void main() {\n        float x = getXAtOutCoords();\n        float mean = getMeanAtOutCoords();\n        float variance = getVarianceAtOutCoords();\n        float offset = " + i2 + ";\n        float scale = " + s2 + ";\n        float inv = scale * inversesqrt(variance + float(" + a2 + "));\n        setOutput(dot(vec3(x, -mean, offset), vec3(inv, inv, 1)));\n      }\n    ";
  ...
  r2 === void 0 && (r2 = false), this.variableNames = ["A", "B"], this.supportsBroadcasting = true, this.packedInputs = true, this.packedOutput = true, this.outputShape = Ro(e2, n2);
...
var qa = function(t2) {
  ...
  var e2 = t2.filterHeight, n2 = t2.filterWidth, r2 = t2.strideHeight, o2 = t2.strideWidth, a2 = t2.dataFormat === "channelsLast", i2 = e2 - 1 - t2.padInfo.top, s2 = n2 - 1 - t2.padInfo.left, u2 = a2 ? 1 : 2, c2 = a2 ? 2 : 3, l2 = a2 ? 3 : 1;
  ...
  var o2 = t2.padInfo.top, a2 = t2.padInfo.left, i2 = t2.strideHeight, s2 = t2.strideWidth, u2 = t2.dilationHeight, c2 = t2.dilationWidth, l2 = t2.filterHeight, h2 = t2.filterWidth, f2 = 4 * Math.floor(t2.inChannels / 4), d2 = t2.inChannels % 4, p2 = t2.dataFormat === "channelsLast", v = p2 ? 1 : 2, m = p2 ? 2 : 3, g2 = p2 ? 3 : 1, y2 = "", x2 = "";
  ...
  e2 === void 0 && (e2 = false), n2 === void 0 && (n2 = null), r2 === void 0 && (r2 = false), this.variableNames = ["x", "W"], this.outputShape = t2.outShape;
  var o2 = t2.inHeight, a2 = t2.inWidth, i2 = t2.padInfo.top, s2 = t2.padInfo.left, u2 = t2.strideHeight, c2 = t2.strideWidth, l2 = t2.dilationHeight, h2 = t2.dilationWidth, f2 = t2.filterHeight, d2 = t2.filterWidth, p2 = t2.outChannels / t2.inChannels, v = "", m = "";
  ...
  for (var o2 = t2.inHeight, a2 = t2.inWidth, i2 = t2.padInfo.top, s2 = t2.padInfo.left, u2 = t2.strideHeight, c2 = t2.strideWidth, l2 = t2.dilationHeight, h2 = t2.dilationWidth, f2 = t2.filterHeight, d2 = t2.filterWidth, p2 = d2, v = "int xR; int xC; int xCOffset;", m = 0; m < f2; m++)
  ...
  var f2 = r2 === "bilinear" ? 1 : 0, d2 = [i2 - 1 + ".0", s2 - 1 + ".0"], p2 = d2[0], v = d2[1], m = l2 > 1 ? ["" + (i2 - 1) / (l2 - 1), "(y2-y1) * height_ratio", "y1*" + p2 + " + float(y)*(height_scale)"] : ["0.0", "0.0", "0.5 * (y1+y2) * " + p2], g2 = m[0], y2 = m[1], x2 = m[2], b2 = h2 > 1 ? ["" + (s2 - 1) / (h2 - 1), "(x2-x1) * width_ratio", "x1*" + v + " + float(x)*(width_scale)"] : ["0.0", "0.0", "0.5 * (x1+x2) * " + v], w2 = b2[0], C2 = b2[1], E2 = b2[2];
...
var Li = function(t2, e2, n2) {
  ...
  for (var r2 = n2.filterWidth, o2 = n2.inChannels, a2 = n2.strideWidth, i2 = n2.strideHeight, s2 = n2.padInfo, u2 = n2.outWidth, c2 = n2.dilationWidth, l2 = n2.dilationHeight, h2 = n2.dataFormat, f2 = s2.left, d2 = s2.top, p2 = o2 * r2, v = ua(), m = h2 === "channelsLast", g2 = m ? 0 : 1, y2 = m ? 1 : 2, x2 = "", b2 = 0; b2 <= 1; b2++)
...
var Xi = function(t2, e2, n2) {
  ...
  if (this.variableNames = ["x"], e2 === "avg" && n2)
    throw new Error("Cannot compute positions for average pool.");
  var r2 = t2.filterWidth, o2 = t2.strideDepth, a2 = t2.strideHeight, i2 = t2.strideWidth, s2 = t2.dilationDepth, u2 = t2.dilationHeight, c2 = t2.dilationWidth, l2 = t2.effectiveFilterDepth, h2 = t2.effectiveFilterHeight, f2 = t2.effectiveFilterWidth, d2 = t2.padInfo.front, p2 = t2.padInfo.top, v = t2.padInfo.left;
  this.outputShape = t2.outShape;
  var m = e2 === "avg", g2 = "0.0";
  if (m || (g2 = "-1.0 / 1e-20"), n2)
...
var ts = function(t2, e2, n2) {
  ...
  var r2 = e2.shape, o2 = r2[1], a2 = r2[2], i2 = t2.shape, s2 = i2[1], u2 = i2[2], c2 = [n2 && s2 > 1 ? o2 - 1 : o2, n2 && u2 > 1 ? a2 - 1 : a2], l2 = [n2 && s2 > 1 ? s2 - 1 : s2, n2 && u2 > 1 ? u2 - 1 : u2], h2 = c2[0] / l2[0], f2 = c2[1] / l2[1], d2 = 1 / h2, p2 = 1 / f2, v = 2 * Math.ceil(d2) + 2, m = 2 * Math.ceil(p2) + 2;
...
var fs = function() {
  function t2(t3) {
    ...
    var e2 = wa(this.rank), n2 = sa("coords", this.rank), r2 = sa("sourceLoc", this.rank), o2 = this.rank === 1 ? "sourceLoc" : "vec2(" + r2.slice(-2).join() + ")", a2 = "getChannel(getSource(" + r2.join() + "), " + o2 + ")", i2 = "\n      result.x = " + a2 + ";\n      if (++" + n2[this.rank - 1] + " < " + t3[this.rank - 1] + ") {\n        ++" + r2[this.rank - 1] + ";\n        result.y = " + a2 + ";\n        --" + r2[this.rank - 1] + ";\n      }\n    ", s2 = this.rank === 1 ? "" : "\n      --" + n2[this.rank - 1] + ";\n      if (++" + n2[this.rank - 2] + " < " + t3[this.rank - 2] + ") {\n        ++" + r2[this.rank - 2] + ";\n        result.z = " + a2 + ";\n        if (++" + n2[this.rank - 1] + " < " + t3[this.rank - 1] + ") {\n          ++" + r2[this.rank - 1] + ";\n          result.w = " + a2 + ";\n        }\n      }\n    ", u2 = this.rank <= 4 ? "sourceLoc = coords +\n            " + e2 + "(" + t3.map(function(t4, e3) {
      return "start[" + e3 + "]";
...
var Zs = function(t2) {
  function o2(e2) {
    ...
    return r2.textureManager = new ps(r2.gpgpu), r2.numMBBeforeWarning = i().global.screen == null ? 1024 : i().global.screen.height * i().global.screen.width * window.devicePixelRatio * Js / 1024 / 1024, r2.texData = new xo(r2, Lt), r2;
  }
  return e(o2, t2), o2.prototype.numDataIds = function() {
    ...
    (d2 && (h2 = et()), r2 === "complex64") ? f2 = Vo(o3.real.dataSync(), o3.imag.dataSync()) : f2 = this.getValuesFromTexture(t3);
    return d2 && (this.downloadWaitMs += et() - h2), this.convertAndCacheOnCPU(t3, f2);
  }, o2.prototype.read = function(t3) {
    return n(this, void 0, void 0, function() {
      var e2, n2, o3, a2, s2, u2, c2, l2, h2, f2, d2, p2, v, m, g2, y2, x2, b2, w2, C2, E2, R2;
      return r(this, function(r2) {
        switch (r2.label) {
          case 0:
            ...
            if (n2 = this.texData.get(t3), o3 = n2.values, a2 = n2.shape, s2 = n2.slice, u2 = n2.dtype, c2 = n2.complexTensors, l2 = n2.isPacked, s2 != null)
            ...
            return p2 = null, u2 !== "complex64" && i().get("WEBGL_BUFFER_SUPPORTED") && (v = this.decode(t3), m = this.texData.get(v.dataId), p2 = (R2 = this.gpgpu).createBufferFromTexture.apply(R2, [m.texture].concat(Yt(a2)))), this.pendingRead.set(t3, []), u2 === "complex64" ? [3, 2] : [4, this.gpgpu.createAndWaitForFence()];
          case 1:
            r2.sent(), r2.label = 2;
          case 2:
          ...
          case 4:
            p2 == null ? g2 = this.getValuesFromTexture(t3) : (w2 = k(a2), g2 = this.gpgpu.downloadFloat32MatrixFromBuffer(p2, w2)), r2.label = 5;
          case 5:
            return v != null && this.disposeData(v.dataId), C2 = this.convertAndCacheOnCPU(t3, g2), E2 = this.pendingRead.get(t3), this.pendingRead.delete(t3), E2.forEach(function(t4) {
              return t4(C2);
    ...
    var h2 = i().getBool("WEBGL_PACK") && a2 === true, f2 = h2 ? Te(r2) : r2, d2 = h2 ? new ci(f2) : new ui(f2), p2 = this.runWebGLProgram(d2, [{ shape: f2, dtype: o3, dataId: t3 }], "float32"), v = this.texData.get(p2.dataId), m = this.gpgpu.downloadByteEncodedFloatMatrixFromOutputTexture(v.texture, v.texShape[0], v.texShape[1]).subarray(0, s2);
    ...
    return e2 === void 0 && (e2 = 128), this.getCPUBackend() != null && t3.every(function(t4) {
      return n2.texData.get(t4.dataId).texture == null && t4.size < e2;
    });
    ...
    if ((o3 === 1 || a2 === 1) && i2 > 1e3) {
      ...
      var u2 = a2 === 1 ? t3 : t3.as3D(s2, i2, 1), c2 = a2 === 1 ? 2 : 1, l2 = a2 === 1 ? e2.as3D(s2, 1, i2) : e2;
    ...
    var e2 = t3.a, n2 = t3.b, r2 = t3.transposeA, o3 = t3.transposeB, a2 = t3.bias, i2 = t3.activation, s2 = t3.preluActivationWeights, u2 = r2 ? e2.shape[2] : e2.shape[1], c2 = o3 ? n2.shape[1] : n2.shape[2], l2 = e2.shape[0], h2 = Dt(e2.dtype, n2.dtype), f2 = a2 != null, d2 = s2 != null, p2 = i2 ? Qs(i2, true) : null, v = new Hi(e2.shape, [l2, u2, c2], r2, o3, f2, p2, d2), m = [e2, n2];
    ...
    var a2 = $r(o3), i2 = new aa({ windowSize: a2, inSize: o3, batchSize: r2 }, e2, n2 == null), s2 = [t3];
    n2 != null && s2.push(n2);
    ...
    n2 === void 0 && (n2 = null);
    var r2 = n2 != null ? n2.shape : t3.shape, o3 = $r(r2[r2.length - 1]), a2 = new Ra(r2, o3, e2, n2 == null), i2 = n2 == null ? [t3] : [t3, n2], s2 = this.compileAndRun(a2, i2, "int32");
    ...
    o3 != null && (a2 = t3.transpose(o3), r2 = In(1, t3.rank)[0]);
    var i2 = function(t4, e3, n3) {
    ...
    return o3 != null && (l2 = l2.transpose(Rn(o3))), l2;
    ...
    var n2 = new Cs(t3.shape, function(t4) {
      return t4 === void 0 && (t4 = 0), Es + "\n    return x > 0.0 ? 1.0 : float(" + t4 + ");\n  ";
    }(e2));
    return this.compileAndRun(n2, [t3]);
  }, o2.prototype.conv2dByMatMul = function(t3, e2, n2, r2, o3, a2) {
    var s2 = t3.shape, u2 = this.texData.get(t3.dataId), c2 = n2.inChannels, l2 = s2[0] * s2[1] * s2[2], h2 = n2.outChannels, f2 = n2.dataFormat === "channelsLast", d2 = (l2 === 1 || h2 === 1) && c2 > 1e3, p2 = s2[2] % 2 != 0 && !!u2.isPacked;
    ...
    var i2 = n2.filterWidth, s2 = n2.filterHeight, u2 = n2.inChannels, c2 = n2.outWidth, l2 = n2.outHeight, h2 = n2.dataFormat === "channelsLast", f2 = i2 * s2 * u2, d2 = l2 * c2, p2 = [f2, d2], v = t3.squeeze([0]), m = e2.reshape([1, f2, -1]), g2 = new Li(p2, v.shape, n2), y2 = this.compileAndRun(g2, [v]).reshape([1, p2[0], p2[1]]), x2 = r2 != null, b2 = a2 != null, w2 = o3 ? Qs(o3, true) : null, C2 = new Hi(y2.shape, [1, d2, n2.outChannels], true, false, x2, w2, b2), E2 = [y2, m];
    ...
    var u2 = o3 != null, c2 = s2 != null, l2 = a2 ? Qs(a2, false) : null, h2 = new Qa(r2, u2, l2, c2), f2 = [e2, n2];
    ...
    var e2, n2 = t3.input, r2 = t3.filter, o3 = t3.convInfo, a2 = t3.bias, s2 = t3.activation, u2 = t3.preluActivationWeights, c2 = i().getBool("WEBGL_PACK_DEPTHWISECONV") && o3.strideWidth <= 2 && o3.outChannels / o3.inChannels == 1, l2 = s2 ? Qs(s2, c2) : null, h2 = [n2, r2], f2 = a2 != null, d2 = u2 != null;
    ...
    var r2 = t3.shape[0], o3 = n2 === "NHWC" ? t3.shape[1] : t3.shape[2], a2 = n2 === "NHWC" ? t3.shape[2] : t3.shape[3], i2 = n2 === "NHWC" ? t3.shape[3] : t3.shape[1], s2 = o3 * e2, u2 = a2 * e2, c2 = i2 / (e2 * e2), l2 = new ii(n2 === "NHWC" ? [r2, s2, u2, c2] : [r2, c2, s2, u2], e2, n2);
    ...
    var f2, d2 = { shape: s2.shape, texData: u2, isUniform: false }, p2 = function(t4, e3, n3) {
      ...
      return function(t4, e3, n3, r3) {
        ...
        i().getNumber("WEBGL_VERSION") === 1 && (h3 = t4.getUniformLocation(l3, "INFINITY", false));
    ...
    }), m && (f2 = this.endTimer(f2), this.activeTimers.push({ name: t3.constructor.name, query: this.getQueryTime(f2) })), !i().getBool("WEBGL_LAZILY_UNPACK") && u2.isPacked && o3 === false) {
...
function Pu(t2, e2, n2, r2, o2, a2) {
  ...
  return o2 != null && (i2 = mn(o2, "scale", "batchNorm")), r2 != null && (s2 = mn(r2, "offset", "batchNorm")), C(u2.rank === 2, function() {
  ...
  }), C(l2.rank === 2 || l2.rank === 1, function() {
...
function Lu(t2, e2, n2, r2, o2, a2) {
  var i2, s2, u2 = mn(t2, "x", "batchNorm"), c2 = mn(e2, "mean", "batchNorm"), l2 = mn(n2, "variance", "batchNorm");
  return o2 != null && (i2 = mn(o2, "scale", "batchNorm")), r2 != null && (s2 = mn(r2, "offset", "batchNorm")), C(u2.rank === 3, function() {
    return "Error in batchNorm3D: x must be rank 3 but got rank " + u2.rank + ".";
  }), C(c2.rank === 3 || c2.rank === 1, function() {
    return "Error in batchNorm3D: mean must be rank 3 or rank 1 but got rank " + c2.rank + ".";
  }), C(l2.rank === 3 || l2.rank === 1, function() {
...
function Wu(t2, e2, n2, r2, o2, a2) {
  var i2, s2, u2 = mn(t2, "x", "batchNorm"), c2 = mn(e2, "mean", "batchNorm"), l2 = mn(n2, "variance", "batchNorm");
  return o2 != null && (i2 = mn(o2, "scale", "batchNorm")), r2 != null && (s2 = mn(r2, "offset", "batchNorm")), C(u2.rank === 4, function() {
  ...
  }), C(l2.rank === 4 || l2.rank === 1, function() {
...
function Uu(t2, e2, n2, r2, o2, a2) {
  ...
  o2 != null && (i2 = mn(o2, "scale", "batchNorm")), r2 != null && (s2 = mn(r2, "offset", "batchNorm")), C(l2.rank === h2.rank, function() {
    return "Batch normalization gradient requires mean and variance to have equal ranks.";
  }), C(s2 == null || l2.rank === s2.rank, function() {
    return "Batch normalization gradient requires mean and offset to have equal ranks.";
  }), C(i2 == null || l2.rank === i2.rank, function() {
    return "Batch normalization gradient requires mean and scale to have equal ranks.";
  }), u2 = c2.rank === 0 || c2.rank === 1 ? c2.as4D(1, 1, 1, c2.size) : c2.rank === 2 ? c2.as4D(1, 1, c2.shape[0], c2.shape[1]) : c2.rank === 3 ? c2.as4D(1, c2.shape[0], c2.shape[1], c2.shape[2]) : c2;
  var f2 = [c2, l2, h2, i2];
  return Lt.runKernelFunc(function(t3, e3) {
    ...
    var n3 = e3, r3 = n3[0], o3 = n3[1], i3 = n3[2], s3 = n3[3], c3 = s3 == null ? On(1) : s3, l3 = Eo(o3.shape, u2.shape), h3 = [];
    if (o3.rank === 1) {
    ...
    return { x: function() {
      return o3.rank === 1 ? t3.mul(Lr(v.as4D(1, 1, 1, o3.shape[0]), h3)).mul(c3).reshape(r3.shape) : t3.mul(v).mul(c3).reshape(r3.shape);
    }, mean: function() {
      var t4 = v.mul(On(-1)).mul(p2);
      return o3.rank === 1 && (t4 = t4.sum(l3)), t4.reshape(o3.shape);
    }, variance: function() {
      var t4 = m.mul(d2).mul(p2);
      return o3.rank === 1 && (t4 = t4.sum(l3)), t4.reshape(o3.shape);
    }, scale: function() {
      var e4 = d2.mul(v), n4 = t3.mul(e4);
      return o3.rank === 1 && (n4 = n4.sum(l3)), n4.reshape(o3.shape);
    }, offset: function() {
      var e4 = t3;
      return o3.rank === 1 && (e4 = e4.sum(l3)), e4.reshape(o3.shape);
    } };
...
var Gu = An({ batchNormalization2d_: function(t2, e2, n2, r2, o2, a2) {
  return r2 === void 0 && (r2 = 1e-3), zu(), Pu(t2, e2, n2, a2, o2, r2);
} }), Hu = An({ batchNormalization3d_: function(t2, e2, n2, r2, o2, a2) {
  return r2 === void 0 && (r2 = 1e-3), zu(), Lu(t2, e2, n2, a2, o2, r2);
} }), qu = An({ batchNormalization4d_: function(t2, e2, n2, r2, o2, a2) {
  return r2 === void 0 && (r2 = 1e-3), zu(), Wu(t2, e2, n2, a2, o2, r2);
} }), Ku = An({ batchNormalization_: function(t2, e2, n2, r2, o2, a2) {
  return r2 === void 0 && (r2 = 1e-3), zu(), Uu(t2, e2, n2, a2, o2, r2);
...
var rc = An({ add_: function(t2, e2) {
  ...
  return n2 = Nt(r2, o2), r2 = n2[0], o2 = n2[1], r2.dtype === "bool" && (r2 = r2.toInt(), o2 = o2.toInt()), Ro(r2.shape, o2.shape), Lt.runKernelFunc(function(t3, e3) {
...
var Lc = An({ gather_: function(t2, e2, n2) {
  ...
  return Lt.runKernelFunc(function(t3, e3) {
    ...
    var o3 = e3[0];
    return { x: function() {
      var e4 = r2.shape, a3 = o3.size, i2 = e4.slice(0, n2), s2 = i2.length, u2 = e4.slice(n2, e4.length).slice(1), c2 = u2.length, l2 = Bc(0, s2), h2 = Bc(s2 + 1, s2 + 1 + c2), f2 = Pc([i2, [a3], u2]), d2 = t3.reshape(f2), p2 = o3.reshape([a3]), v = Pc([[s2], l2, h2]), m = d2.transpose(v), g2 = Wc(m, p2, r2.shape[n2]), y2 = Rn(v);
...
var Uc = function(t2, e2, o2) {
  return n(this, void 0, void 0, function() {
    var n2, a2, i2, s2, u2, c2, l2, h2, f2, d2, p2, v, m;
    return r(this, function(r2) {
      switch (r2.label) {
        case 0:
          for (n2 = mn(t2, "tensor", "boolMask"), a2 = mn(e2, "mask", "boolMask", "bool"), i2 = o2 == null ? 0 : o2, s2 = a2.rank, u2 = n2.shape, C(s2 > 0, function() {
...
function Vc(t2, e2, n2, r2, o2, a2, i2) {
  ...
  var l2 = a2 === "NHWC" ? s2[3] : s2[1], h2 = a2 === "NHWC" ? u2.shape[3] : u2.shape[1];
...
var Hc = An({ conv1d_: function(t2, e2, n2, r2, o2, a2, i2) {
  ...
  s2.rank === 2 && (l2 = true, c2 = s2.as3D(1, s2.shape[0], s2.shape[1])), C(c2.rank === 3, function() {
  ...
  s2.rank === 3 && (l2 = true, c2 = s2.as4D(1, s2.shape[0], s2.shape[1], s2.shape[2])), C(c2.rank === 4, function() {
  ...
  var f2 = Bo(o2), d2 = So(c2.shape, u2.shape, n2, a2, r2, i2, false, f2), p2 = [u2, c2], v = Lt.runKernelFunc(function(t3, e3) {
  ...
  var c2 = a2 === "NHWC" ? s2.shape[3] : s2.shape[1], l2 = a2 === "NHWC" ? u2.shape[3] : u2.shape[1];
  C(c2 === n2[2], function() {
  ...
  }), a2 == null && (a2 = [1, 1]), C(Mo(n2, a2), function() {
  ...
  if (s2.rank === 3 && (h2 = true, l2 = s2.as4D(1, s2.shape[0], s2.shape[1], s2.shape[2])), i2 === "NCHW")
    throw new Error("separableConv2d currently does not support dataFormat NCHW; only NHWC is supported");
  C(l2.rank === 4, function() {
  ...
  var p2 = Yc(l2, u2, r2, o2, i2, a2), v = qc(p2, c2, 1, "valid", i2);
...
var el = An({ matMul_: function(t2, e2, n2, r2) {
  ...
  var v = a2.shape.slice(0, -2).concat([c2, l2]), m = n2 ? a2.as3D(d2, s2, c2) : a2.as3D(d2, c2, s2), g2 = r2 ? i2.as3D(p2, l2, u2) : i2.as3D(p2, u2, l2), y2 = { transposeA: n2, transposeB: r2 };
  return Lt.runKernelFunc(function(t3, e3) {
...
function ll(t2, e2, n2, r2, o2, a2) {
  ...
  r2 == null && (r2 = [1, 1]), C(Mo(n2, r2), function() {
  ...
  var l2 = Lt.runKernelFunc(function(t3) {
    ...
    return { x: function() {
      return function(t4, e3, n3, r3, o3, a3) {
        ...
        s3.rank === 3 && (l3 = true, u3 = s3.as4D(1, s3.shape[0], s3.shape[1], s3.shape[2]), c3 = i3.as4D(1, i3.shape[0], i3.shape[1], i3.shape[2]));
        C(c3.rank === 4, function() {
...
var hl = An({ maxPool_: function(t2, e2, n2, r2, o2) {
  ...
  var i2 = mn(t2, "x", "maxPool"), s2 = i2, u2 = false;
  i2.rank === 3 && (u2 = true, s2 = i2.as4D(1, i2.shape[0], i2.shape[1], i2.shape[2])), C(Mo(a2, o2), function() {
  ...
  var f2 = h2[0] === 1 && h2[1] === 1, d2 = function(t3, e3, n3) {
    ...
    return [u3, c3];
  }([l2.inHeight, l2.inWidth], h2, c2), p2 = d2[0], v = d2[1], m = f2 ? r2 : "valid", g2 = f2 ? s2 : Mr(s2, h2, p2), y2 = (n2 === "avg" ? function() {
  ...
  var l2 = ko(u2.shape, e2, n2, i2, r2, o2, a2), h2 = Lt.runKernelFunc(function(t3, e3) {
    ...
    return { x: function() {
      return function(t4, e3, n3, r3, o3, a4, i3, s4) {
        ...
        c3.rank === 4 && (p2 = true, h3 = u4.as5D(1, u4.shape[0], u4.shape[1], u4.shape[2], u4.shape[3]), f2 = c3.as5D(1, c3.shape[0], c3.shape[1], c3.shape[2], c3.shape[3]), d2 = l3.as5D(1, l3.shape[0], l3.shape[1], l3.shape[2], l3.shape[3]));
        ...
        if (p2)
          return m.as4D(m.shape[1], m.shape[2], m.shape[3], m.shape[4]);
        return m;
  ...
  var l2 = ko(u2.shape, e2, n2, i2, r2, o2, a2), h2 = Lt.runKernelFunc(function(t3) {
    ...
    return { x: function() {
      return function(t4, e3, n3, r3, o3, a3, i3) {
        ...
        u3.rank === 4 && (h3 = true, c3 = s3.as5D(1, s3.shape[0], s3.shape[1], s3.shape[2], s3.shape[3]), l3 = u3.as5D(1, u3.shape[0], u3.shape[1], u3.shape[2], u3.shape[3]));
        C(c3.rank === 5, function() {
          return "Error in avgPool3dBackprop: dy must be rank 5 but got rank " + c3.rank + ".";
        }), C(l3.rank === 5, function() {
...
var Xl = An({ fft_: function(t2) {
  ...
  if (e2 != null && e2 < r2) {
    ...
    n2 = t2;
  var u2 = n2.zerosLike(), c2 = Dn(n2, u2).as2D(o2, r2), l2 = Xl(c2), h2 = Math.floor(r2 / 2) + 1, f2 = Tn(l2), d2 = Nn(l2), p2 = f2.split([h2, r2 - h2], f2.shape.length - 1), v = d2.split([h2, r2 - h2], d2.shape.length - 1), m = n2.shape.slice();
...
var oh = An({ hannWindow_: function(t2) {
  ...
  var a2;
  o2 === void 0 && (o2 = oh), r2 == null && (a2 = e2, r2 = Math.floor(Math.pow(2, Math.ceil(Math.log(a2) / Math.log(2)))));
...
var ch, lh = function(t2, e2, o2) {
  return o2 === void 0 && (o2 = 1), n(this, void 0, void 0, function() {
    var n2, a2, i2, s2, u2, c2, l2, h2, f2, d2, p2, v, m, g2;
    return r(this, function(r2) {
      switch (r2.label) {
        case 0:
        ...
        case 2:
          for (u2 = r2.sent(), c2 = [s2.length / i2, i2], h2 = c2[1], f2 = B("bool", l2 = c2[0]), d2 = 0; d2 < l2; d2++) {
            for (p2 = d2 * h2, v = s2.subarray(p2, p2 + h2), m = [], g2 = 0; g2 < v.length; g2++)
              m.push({ value: v[g2], index: g2 });
...
var hh = An({ absoluteDifference_: function(t2, e2, n2, r2) {
  r2 === void 0 && (r2 = ch.SUM_BY_NONZERO_WEIGHTS);
  var o2 = mn(t2, "labels", "absoluteDifference"), a2 = mn(e2, "predictions", "absoluteDifference"), i2 = null;
  n2 != null && (i2 = mn(n2, "weights", "absoluteDifference")), E(o2.shape, a2.shape, "Error in absoluteDifference: ");
  var s2 = o2.sub(a2).abs();
  return fh(s2, i2, r2);
} }), fh = An({ computeWeightedLoss_: function(t2, e2, n2) {
  n2 === void 0 && (n2 = ch.SUM_BY_NONZERO_WEIGHTS);
  var r2 = mn(t2, "losses", "computeWeightedLoss"), o2 = null;
  e2 != null && (o2 = mn(e2, "weights", "computeWeightedLoss"));
  ...
  o2 === void 0 && (o2 = ch.SUM_BY_NONZERO_WEIGHTS);
  var a2 = mn(t2, "labels", "cosineDistance"), i2 = mn(e2, "predictions", "cosineDistance"), s2 = null;
  r2 != null && (s2 = mn(r2, "weights", "cosineDistance")), E(a2.shape, i2.shape, "Error in cosineDistance: ");
  ...
  n2 != null && (i2 = mn(n2, "weights", "hingeLoss")), E(o2.shape, a2.shape, "Error in hingeLoss: ");
  var s2 = On(1);
  o2 = On(2).mul(o2).sub(s2);
  var u2 = s2.sub(o2.mul(a2)).relu();
  return fh(u2, i2, r2);
} }), vh = An({ huberLoss_: function(t2, e2, n2, r2, o2) {
  r2 === void 0 && (r2 = 1), o2 === void 0 && (o2 = ch.SUM_BY_NONZERO_WEIGHTS);
  var a2 = mn(t2, "labels", "huberLoss"), i2 = mn(e2, "predictions", "huberLoss"), s2 = null;
  n2 != null && (s2 = mn(n2, "weights", "huberLoss")), E(a2.shape, i2.shape, "Error in huberLoss: ");
  ...
  r2 === void 0 && (r2 = 1e-7), o2 === void 0 && (o2 = ch.SUM_BY_NONZERO_WEIGHTS);
  var a2 = mn(t2, "labels", "logLoss"), i2 = mn(e2, "predictions", "logLoss"), s2 = null;
  n2 != null && (s2 = mn(n2, "weights", "logLoss")), E(a2.shape, i2.shape, "Error in logLoss: ");
  ...
  n2 != null && (i2 = mn(n2, "weights", "meanSquaredError")), E(o2.shape, a2.shape, "Error in meanSquaredError: ");
  var s2 = o2.squaredDifference(a2);
  return fh(s2, i2, r2);
} }), yh = An({ sigmoidCrossEntropy_: function(t2, e2, n2, r2, o2) {
  r2 === void 0 && (r2 = 0), o2 === void 0 && (o2 = ch.SUM_BY_NONZERO_WEIGHTS);
  var a2 = mn(t2, "multiClassLabels", "sigmoidCrossEntropy"), i2 = mn(e2, "logits", "sigmoidCrossEntropy"), s2 = null;
  if (n2 != null && (s2 = mn(n2, "weights", "sigmoidCrossEntropy")), E(a2.shape, i2.shape, "Error in sigmoidCrossEntropy: "), r2 > 0) {
  ...
  if (n2 != null && (s2 = mn(n2, "weights", "softmaxCrossEntropy")), E(a2.shape, i2.shape, "Error in softmaxCrossEntropy: "), r2 > 0) {
  ...
  return e2 === void 0 && (e2 = false), Lt.tidy(function() {
    ...
    for (var n2 = t2.shape[0], r2 = t2.shape[1], o2 = Cr(n2), a2 = t2.clone(), i2 = Bn([[1]], [1, 1]), s2 = i2.clone(), u2 = n2 >= r2 ? r2 : n2, c2 = function(t3) {
      ...
      e3 = Lt.tidy(function() {
        ...
        var d2 = l4.matMul(h2).div(u4).neg(), p2 = a2.slice([t3, 0], [n2 - t3, r2]), v = d2.mul(s2);
        if (t3 === 0)
          a2 = p2.sub(v.matMul(s2.transpose().matMul(p2)));
        else {
        ...
        if (t3 === 0)
          o2 = g2.sub(g2.matMul(s2).matMul(v.transpose()));
        else {
...
var Wh = An({ fusedMatMul_: function(t2) {
  var e2, n2 = t2.a, r2 = t2.b, o2 = t2.transposeA, a2 = o2 !== void 0 && o2, i2 = t2.transposeB, s2 = i2 !== void 0 && i2, u2 = t2.bias, c2 = t2.activation, l2 = c2 === void 0 ? "linear" : c2, h2 = t2.preluActivationWeights;
  if (Mh(Lt.state.gradientDepth, l2) === false) {
    var f2 = el(n2, r2, a2, s2);
    return u2 != null && (f2 = rc(f2, u2)), Lh(f2, l2, h2);
  }
  ...
  u2 != null && Ro(A2, (R2 = Nt(R2 = mn(u2, "bias", "fused matMul"), d2)[0]).shape), h2 != null && (I2 = mn(h2, "prelu weights", "fused matMul"));
  var N2 = { a: D2, b: T2 };
  ...
  var e2 = t2.x, n2 = t2.filter, r2 = t2.strides, o2 = t2.pad, a2 = t2.dataFormat, i2 = a2 === void 0 ? "NHWC" : a2, s2 = t2.dilations, u2 = s2 === void 0 ? [1, 1] : s2, c2 = t2.dimRoundingMode, l2 = t2.bias, h2 = t2.activation, f2 = h2 === void 0 ? "linear" : h2, d2 = t2.preluActivationWeights;
  if (f2 = f2 || "linear", Mh(Lt.state.gradientDepth, f2) === false) {
    var p2 = qc(e2, n2, r2, o2, i2, u2, c2);
    return l2 != null && (p2 = rc(p2, l2)), Lh(p2, f2, d2);
  }
  var v = mn(e2, "x", "conv2d"), m = mn(n2, "filter", "conv2d"), g2 = v, y2 = false;
  v.rank === 3 && (y2 = true, g2 = v.as4D(1, v.shape[0], v.shape[1], v.shape[2])), C(g2.rank === 4, function() {
  ...
  var x2, b2, w2 = So(g2.shape, m.shape, r2, u2, o2, c2);
  l2 != null && (x2 = Nt(x2 = mn(l2, "bias", "fused conv2d"), v)[0], Ro(w2.outShape, x2.shape)), d2 != null && (b2 = mn(d2, "prelu weights", "fused conv2d"));
  var E2 = { x: g2, filter: m };
  l2 != null && (E2.bias = x2), d2 != null && (E2.preluActivationWeights = b2);
  var R2 = [m, g2], I2 = Lt.runKernelFunc(function(t3, e3) {
    ...
    var h3 = {};
    return l2 != null && (h3 = { bias: function() {
      return Ph(x2, c3);
  ...
  var e2 = t2.x, n2 = t2.filter, r2 = t2.strides, o2 = t2.pad, a2 = t2.dataFormat, i2 = a2 === void 0 ? "NHWC" : a2, s2 = t2.dilations, u2 = s2 === void 0 ? [1, 1] : s2, c2 = t2.dimRoundingMode, l2 = t2.bias, h2 = t2.activation, f2 = h2 === void 0 ? "linear" : h2, d2 = t2.preluActivationWeights;
  if (Mh(Lt.state.gradientDepth, f2) === false) {
  ...
  }), u2 == null && (u2 = [1, 1]), C(Mo(r2, u2), function() {
  ...
  var x2, b2, w2 = So(g2.shape, m.shape, r2, u2, o2, c2, true);
  l2 != null && (x2 = Nt(x2 = mn(l2, "bias", "fused conv2d"), v)[0], Ro(w2.outShape, x2.shape)), d2 != null && (b2 = mn(d2, "prelu weights", "fused depthwiseConv2d"));
  var E2 = { x: g2, filter: m };
  l2 != null && (E2.bias = x2), d2 != null && (E2.preluActivationWeights = b2);
  var R2 = [m, g2], I2 = Lt.runKernelFunc(function(t3, e3) {
    ...
    return l2 != null && (i3 = { bias: function() {
      return Ph(x2, a3);
    } }), Object.assign({ x: function() {
...
var Kh = function(t2) {
  ...
  return e(o2, t2), o2.prototype.write = function(t3, e2, n2) {
    ...
    return n2 === "complex64" ? Vo(this.readSync(r2.real.dataId), this.readSync(r2.imag.dataId)) : this.data.get(t3).values;
    ...
    Hh([t3, e2], "matMul");
    for (var o3 = n2 ? t3.shape[1] : t3.shape[2], a2 = n2 ? t3.shape[2] : t3.shape[1], i2 = r2 ? e2.shape[1] : e2.shape[2], s2 = t3.shape[0], u2 = this.readSync(t3.dataId), c2 = this.readSync(e2.dataId), l2 = n2 ? [t3.strides[0], 1, t3.strides[1]] : [t3.strides[0], t3.strides[1], 1], h2 = l2[0], f2 = l2[1], d2 = l2[2], p2 = r2 ? [1, e2.strides[1], e2.strides[0]] : [e2.strides[1], 1, e2.strides[0]], v = p2[0], m = p2[1], g2 = p2[2], y2 = a2 * i2, x2 = dr([s2, a2, i2], t3.dtype), b2 = x2.values, w2 = this.blockSize, C2 = 0; C2 < s2; C2++)
            ...
            for (var k2 = Math.min(E2 + w2, a2), S2 = Math.min(R2 + w2, i2), A2 = Math.min(I2 + w2, o3), D2 = E2; D2 < k2; D2++)
              for (var T2 = R2; T2 < S2; T2++) {
                for (var N2 = 0, F2 = I2; F2 < A2; F2++)
                  N2 += u2[C2 * h2 + D2 * f2 + F2 * d2] * c2[F2 * v + T2 * m + C2 * g2];
    ...
    Hh([t3, e2, n2], "select");
    for (var r2 = this.readSync(t3.dataId), o3 = this.readSync(e2.dataId), a2 = this.readSync(n2.dataId), i2 = Gn(e2.shape, Dt(e2.dtype, n2.dtype)), s2 = this.readSync(i2.dataId), u2 = 0, c2 = t3.rank === 0 || t3.rank > 1 || e2.rank === 1 ? 1 : k(e2.shape.slice(1)), l2 = 0; l2 < r2.length; l2++)
      for (var h2 = 0; h2 < c2; h2++)
        r2[l2] === 1 ? s2[u2++] = o3[l2] : s2[u2++] = a2[l2];
    return i2;
  }, o2.prototype.where = function(t3) {
    Hh([t3], "where");
    ...
    Hh([t3, e2], "conv2d");
    for (var r2 = n2.filterHeight, o3 = n2.filterWidth, a2 = n2.dilationHeight, i2 = n2.dilationWidth, s2 = n2.padInfo.left, u2 = n2.padInfo.top, c2 = n2.dataFormat === "channelsLast", l2 = dr(n2.outShape, t3.dtype), h2 = t3.strides[0], f2 = c2 ? t3.strides[1] : t3.strides[2], d2 = c2 ? t3.strides[2] : 1, p2 = c2 ? 1 : t3.strides[1], v = l2.strides[0], m = c2 ? l2.strides[1] : l2.strides[2], g2 = c2 ? l2.strides[2] : 1, y2 = c2 ? 1 : l2.strides[1], x2 = this.readSync(t3.dataId), b2 = this.readSync(e2.dataId), w2 = l2.values, C2 = 0; C2 < n2.batchSize; ++C2)
      for (var E2 = C2 * h2, R2 = C2 * v, I2 = 0; I2 < n2.outHeight; ++I2)
        for (var k2 = R2 + I2 * m, S2 = I2 * n2.strideHeight - u2, A2 = 0; A2 < r2; A2++) {
          var D2 = S2 + A2 * a2;
    ...
    for (var r2 = n2.filterDepth, o3 = n2.filterHeight, a2 = n2.filterWidth, i2 = n2.dilationDepth, s2 = n2.dilationHeight, u2 = n2.dilationWidth, c2 = n2.padInfo.front, l2 = n2.padInfo.left, h2 = n2.padInfo.top, f2 = dr(n2.outShape, t3.dtype), d2 = this.readSync(t3.dataId), p2 = this.readSync(e2.dataId), v = f2.values, m = 0; m < n2.batchSize; ++m)
      for (var g2 = m * t3.strides[0], y2 = m * f2.strides[0], x2 = 0; x2 < n2.outDepth; ++x2)
    ...
    for (var r2 = dr(n2.inShape, "float32"), o3 = r2.values, a2 = this.readSync(t3.dataId), i2 = this.readSync(e2.dataId), s2 = e2.strides, u2 = s2[0], c2 = s2[1], l2 = s2[2], h2 = n2.batchSize, f2 = n2.filterHeight, d2 = n2.filterWidth, p2 = n2.inChannels, v = n2.inHeight, m = n2.inWidth, g2 = n2.outChannels, y2 = n2.outHeight, x2 = n2.outWidth, b2 = n2.strideHeight, w2 = n2.strideWidth, C2 = n2.dataFormat, E2 = f2 - 1 - n2.padInfo.top, R2 = d2 - 1 - n2.padInfo.left, I2 = C2 === "channelsLast", k2 = r2.strides[0], S2 = I2 ? r2.strides[1] : r2.strides[2], A2 = I2 ? r2.strides[2] : 1, D2 = I2 ? 1 : r2.strides[1], T2 = t3.strides[0], N2 = I2 ? t3.strides[1] : t3.strides[2], F2 = I2 ? t3.strides[2] : 1, _2 = I2 ? 1 : t3.strides[1], O2 = 0; O2 < h2; ++O2)
      for (var M2 = 0; M2 < p2; ++M2)
        for (var B2 = 0; B2 < v; ++B2)
          for (var P2 = B2 - E2, L2 = Math.max(0, Math.ceil(P2 / b2)), W2 = Math.min(y2, (f2 + P2) / b2), U2 = 0; U2 < m; ++U2) {
              ...
              for (var Q2 = $2 - W2, J2 = Math.max(0, Math.ceil(Q2 / B2)), Z2 = Math.min(_2, (I2 + Q2) / B2), tt2 = 0, et2 = H2; et2 < q2; ++et2)
                for (var nt2 = et2 * O2 - G2, rt2 = X2; rt2 < Y2; ++rt2)
                  for (var ot2 = rt2 * M2 - j2, at2 = J2; at2 < Z2; ++at2)
                    for (var it2 = f2 * U2 + d2 * et2 + p2 * rt2 + v * at2, st = y2 * (E2 - 1 - nt2) + x2 * (R2 - 1 - ot2) + b2 * (I2 - 1 - (at2 * B2 - Q2)) + w2 * V2, ut2 = 0; ut2 < T2; ++ut2) {
                      tt2 += l2[it2 + ut2] * m[st + ut2];
                    }
    ...
    for (var r2 = n2.strideHeight, o3 = n2.strideWidth, a2 = n2.filterHeight, i2 = n2.filterWidth, s2 = n2.dataFormat === "channelsLast", u2 = dr(n2.filterShape, "float32"), c2 = n2.padInfo.left, l2 = n2.padInfo.top, h2 = this.bufferSync(t3), f2 = this.bufferSync(e2), d2 = 0; d2 < a2; ++d2)
      for (var p2 = Math.max(0, Math.ceil((l2 - d2) / r2)), v = Math.min(n2.outHeight, (n2.inHeight + l2 - d2) / r2), m = 0; m < i2; ++m)
        for (var g2 = Math.max(0, Math.ceil((c2 - m) / o3)), y2 = Math.min(n2.outWidth, (n2.inWidth + c2 - m) / o3), x2 = 0; x2 < n2.inChannels; ++x2)
          for (var b2 = 0; b2 < n2.outChannels; ++b2) {
            ...
            u2.set(w2, d2, m, x2, b2);
          }
    return u2.toTensor();
  }, o2.prototype.conv3dDerFilter = function(t3, e2, n2) {
    for (var r2 = n2.strideDepth, o3 = n2.strideHeight, a2 = n2.strideWidth, i2 = n2.filterDepth, s2 = n2.filterHeight, u2 = n2.filterWidth, c2 = dr(n2.filterShape, "float32"), l2 = c2.values, h2 = c2.strides, f2 = h2[0], d2 = h2[1], p2 = h2[2], v = h2[3], m = this.readSync(e2.dataId), g2 = e2.strides, y2 = g2[0], x2 = g2[1], b2 = g2[2], w2 = g2[3], C2 = this.readSync(t3.dataId), E2 = t3.strides, R2 = E2[0], I2 = E2[1], k2 = E2[2], S2 = E2[3], A2 = n2.padInfo.front, D2 = n2.padInfo.left, T2 = n2.padInfo.top, N2 = 0; N2 < i2; ++N2)
    ...
    for (var r2 = n2.filterHeight, o3 = n2.filterWidth, a2 = n2.dilationHeight, i2 = n2.dilationWidth, s2 = n2.padInfo.left, u2 = n2.padInfo.top, c2 = n2.outChannels / n2.inChannels, l2 = dr(n2.outShape, t3.dtype), h2 = this.readSync(t3.dataId), f2 = this.readSync(e2.dataId), d2 = l2.values, p2 = 0; p2 < n2.batchSize; ++p2)
      for (var v = p2 * t3.strides[0], m = p2 * l2.strides[0], g2 = 0; g2 < n2.outHeight; ++g2)
        for (var y2 = m + g2 * l2.strides[1], x2 = g2 * n2.strideHeight - s2, b2 = 0; b2 < r2; ++b2) {
          var w2 = x2 + b2 * a2;
    ...
    for (var r2 = dr(n2.inShape, "float32"), o3 = r2.values, a2 = r2.strides, i2 = a2[0], s2 = a2[1], u2 = a2[2], c2 = this.readSync(t3.dataId), l2 = t3.strides, h2 = l2[0], f2 = l2[1], d2 = l2[2], p2 = this.readSync(e2.dataId), v = e2.strides, m = v[0], g2 = v[1], y2 = v[2], x2 = n2.batchSize, b2 = n2.filterHeight, w2 = n2.filterWidth, C2 = n2.inChannels, E2 = n2.inHeight, R2 = n2.inWidth, I2 = n2.outChannels, k2 = n2.outHeight, S2 = n2.outWidth, A2 = n2.strideHeight, D2 = n2.strideWidth, T2 = b2 - 1 - n2.padInfo.top, N2 = w2 - 1 - n2.padInfo.left, F2 = I2 / C2, _2 = 0; _2 < x2; ++_2)
          ...
          for (var B2 = M2 - T2, P2 = Math.max(0, Math.ceil(B2 / A2)), L2 = Math.min(k2, (b2 + B2) / A2), W2 = 0; W2 < R2; ++W2) {
            for (var U2 = W2 - N2, V2 = Math.max(0, Math.ceil(U2 / D2)), z2 = Math.min(S2, (w2 + U2) / D2), G2 = 0, H2 = P2; H2 < L2; ++H2)
              for (var q2 = H2 * A2 - B2, K2 = V2; K2 < z2; ++K2)
                for (var j2 = h2 * _2 + f2 * H2 + d2 * K2, X2 = m * (b2 - 1 - q2) + g2 * (w2 - 1 - (K2 * D2 - U2)) + y2 * O2, Y2 = 0; Y2 < F2; ++Y2) {
    ...
    for (var r2 = n2.strideHeight, o3 = n2.strideWidth, a2 = n2.filterHeight, i2 = n2.filterWidth, s2 = dr(n2.filterShape, "float32"), u2 = n2.padInfo.left, c2 = n2.padInfo.top, l2 = n2.outChannels / n2.inChannels, h2 = this.bufferSync(t3), f2 = this.bufferSync(e2), d2 = 0; d2 < a2; ++d2)
      for (var p2 = Math.max(0, Math.ceil((c2 - d2) / r2)), v = Math.min(n2.outHeight, (n2.inHeight + c2 - d2) / r2), m = 0; m < i2; ++m)
        for (var g2 = Math.max(0, Math.ceil((u2 - m) / o3)), y2 = Math.min(n2.outWidth, (n2.inWidth + u2 - m) / o3), x2 = 0; x2 < n2.outChannels; ++x2) {
    ...
    Hh(t3, "pool");
    for (var r2 = e2.strideHeight, o3 = e2.strideWidth, a2 = e2.dilationHeight, i2 = e2.dilationWidth, s2 = e2.effectiveFilterHeight, u2 = e2.effectiveFilterWidth, c2 = e2.padInfo.top, l2 = e2.padInfo.left, h2 = n2 === "max" ? Number.NEGATIVE_INFINITY : Number.POSITIVE_INFINITY, f2 = this.readSync(t3.dataId), d2 = dr(e2.outShape, t3.dtype), p2 = d2.values, v = e2.outShape[1] * e2.outShape[2] * e2.outShape[3], m = e2.outShape[2] * e2.outShape[3], g2 = e2.outShape[3], y2 = 0; y2 < e2.batchSize; ++y2)
      for (var x2 = y2 * v, b2 = y2 * t3.strides[0], w2 = 0; w2 < e2.inChannels; ++w2)
        for (var C2 = 0; C2 < e2.outHeight; ++C2)
          for (var E2 = C2 * r2 - c2, R2 = Math.max(0, E2), I2 = Math.min(e2.inHeight, s2 + E2), k2 = x2 + C2 * m, S2 = 0; S2 < e2.outWidth; ++S2) {
            for (var A2 = S2 * o3 - l2, D2 = Math.max(0, A2), T2 = Math.min(e2.inWidth, u2 + A2), N2 = h2, F2 = 0, _2 = 0, O2 = R2; O2 < I2; O2 += a2) {
              for (var M2 = b2 + O2 * t3.strides[1], B2 = D2; B2 < T2; B2 += i2) {
                ...
                n2 === "max" && P2 > N2 ? N2 = P2 : n2 === "avg" && (F2 += P2, _2++);
              }
              if (isNaN(N2))
                break;
            }
            p2[k2 + S2 * g2 + w2] = n2 === "avg" ? F2 / _2 : N2;
          }
    return d2.toTensor();
  }, o2.prototype.maxPool = function(t3, e2) {
    ...
    for (var n2 = dr(e2.outShape, "int32"), r2 = e2.strideHeight, o3 = e2.strideWidth, a2 = e2.dilationHeight, i2 = e2.dilationWidth, s2 = e2.effectiveFilterHeight, u2 = e2.effectiveFilterWidth, c2 = e2.padInfo.top, l2 = e2.padInfo.left, h2 = this.bufferSync(t3), f2 = 0; f2 < e2.batchSize; ++f2)
      for (var d2 = 0; d2 < e2.inChannels; ++d2)
        for (var p2 = 0; p2 < e2.outHeight; ++p2) {
          for (var v = p2 * r2 - c2, m = v; m < 0; )
            m += a2;
          for (var g2 = Math.min(e2.inHeight, s2 + v), y2 = 0; y2 < e2.outWidth; ++y2) {
            for (var x2 = y2 * o3 - l2, b2 = x2; b2 < 0; )
              b2 += i2;
            for (var w2 = Math.min(e2.inWidth, u2 + x2), C2 = Number.NEGATIVE_INFINITY, E2 = -1, R2 = m; R2 < g2; R2 += a2)
              for (var I2 = R2 - v, k2 = b2; k2 < w2; k2 += i2) {
    ...
    for (var r2 = n2.strideHeight, o3 = n2.strideWidth, a2 = n2.filterHeight, i2 = n2.filterWidth, s2 = n2.dilationHeight, u2 = n2.dilationWidth, c2 = n2.effectiveFilterHeight, l2 = n2.effectiveFilterWidth, h2 = l2 - 1 - n2.padInfo.left, f2 = c2 - 1 - n2.padInfo.top, d2 = dr(e2.shape, "float32"), p2 = 1 / (a2 * i2), v = this.bufferSync(t3), m = 0; m < n2.batchSize; ++m)
    ...
    for (var o3 = t3.shape, a2 = o3[0], i2 = o3[1], s2 = o3[2], u2 = o3[3], c2 = this.readSync(t3.dataId), l2 = new Float32Array(k([a2, e2, n2, u2])), h2 = [r2 && e2 > 1 ? i2 - 1 : i2, r2 && n2 > 1 ? s2 - 1 : s2], f2 = [r2 && e2 > 1 ? e2 - 1 : e2, r2 && n2 > 1 ? n2 - 1 : n2], d2 = 0, p2 = h2[0] / f2[0], v = h2[1] / f2[1], m = 0; m < a2; m++)
      for (var g2 = 0; g2 < e2; g2++)
        for (var y2 = p2 * g2, x2 = Math.floor(y2), b2 = y2 - x2, w2 = Math.min(i2 - 1, Math.ceil(y2)), C2 = m * t3.strides[0] + x2 * t3.strides[1], E2 = m * t3.strides[0] + w2 * t3.strides[1], R2 = 0; R2 < n2; R2++)
          for (var I2 = v * R2, S2 = Math.floor(I2), A2 = I2 - S2, D2 = Math.min(s2 - 1, Math.ceil(I2)), T2 = C2 + S2 * t3.strides[2], N2 = E2 + S2 * t3.strides[2], F2 = C2 + D2 * t3.strides[2], _2 = E2 + D2 * t3.strides[2], O2 = 0; O2 < u2; O2++) {
    ...
    for (var r2 = e2.shape, o3 = r2[0], a2 = r2[1], i2 = r2[2], s2 = r2[3], u2 = t3.shape, c2 = u2[1], l2 = u2[2], h2 = new Float32Array(o3 * a2 * i2 * s2), f2 = [n2 && c2 > 1 ? a2 - 1 : a2, n2 && l2 > 1 ? i2 - 1 : i2], d2 = [n2 && c2 > 1 ? c2 - 1 : c2, n2 && l2 > 1 ? l2 - 1 : l2], p2 = f2[0] / d2[0], v = f2[1] / d2[1], m = this.readSync(t3.dataId), g2 = 0, y2 = 0; y2 < o3; y2++)
      for (var x2 = y2 * e2.strides[0], b2 = 0; b2 < c2; b2++)
        for (var w2 = b2 * p2, C2 = Math.floor(w2), E2 = Math.min(Math.ceil(w2), a2 - 1), R2 = x2 + C2 * e2.strides[1], I2 = x2 + E2 * e2.strides[1], k2 = w2 - C2, S2 = 1 - k2, A2 = 0; A2 < l2; A2++)
          for (var D2 = A2 * v, T2 = Math.floor(D2), N2 = Math.min(Math.ceil(D2), i2 - 1), F2 = D2 - T2, _2 = 1 - F2, O2 = R2 + T2 * e2.strides[2], M2 = R2 + N2 * e2.strides[2], B2 = I2 + T2 * e2.strides[2], P2 = I2 + N2 * e2.strides[2], L2 = S2 * _2, W2 = S2 * F2, U2 = k2 * _2, V2 = k2 * F2, z2 = 0; z2 < s2; z2++) {
            var G2 = m[g2++];
    ...
    for (var o3 = t3.shape, a2 = o3[0], i2 = o3[1], s2 = o3[2], u2 = o3[3], c2 = this.readSync(t3.dataId), l2 = new Float32Array(a2 * e2 * n2 * u2), h2 = [r2 && e2 > 1 ? i2 - 1 : i2, r2 && n2 > 1 ? s2 - 1 : s2], f2 = [r2 && e2 > 1 ? e2 - 1 : e2, r2 && n2 > 1 ? n2 - 1 : n2], d2 = h2[0] / f2[0], p2 = h2[1] / f2[1], v = 0, m = 0; m < a2; m++)
      for (var g2 = m * t3.strides[0], y2 = 0; y2 < e2; y2++)
    ...
    for (var r2 = e2.shape, o3 = r2[0], a2 = r2[1], i2 = r2[2], s2 = r2[3], u2 = t3.shape, c2 = u2[1], l2 = u2[2], h2 = new Float32Array(o3 * a2 * i2 * s2), f2 = this.readSync(t3.dataId), d2 = [n2 && c2 > 1 ? a2 - 1 : a2, n2 && l2 > 1 ? i2 - 1 : i2], p2 = [n2 && c2 > 1 ? c2 - 1 : c2, n2 && l2 > 1 ? l2 - 1 : l2], v = d2[0] / p2[0], m = d2[1] / p2[1], g2 = 1 / v, y2 = 1 / m, x2 = 2 * Math.ceil(g2) + 2, b2 = 2 * Math.ceil(y2) + 2, w2 = 0; w2 < o3; w2++)
    ...
    for (var s2 = t3.shape[3], u2 = this.readSync(t3.dataId), c2 = this.readSync(e2.dataId), l2 = this.readSync(n2.dataId), h2 = new Float32Array(t3.size), f2 = t3.size, d2 = 0; d2 < f2; d2++) {
      for (var p2 = d2 % s2, v = d2 - p2 + Math.max(0, p2 - r2), m = d2 - p2 + Math.min(s2, p2 + r2 + 1), g2 = 0, y2 = v; y2 < m; y2++)
        g2 += Math.pow(c2[y2], 2);
      g2 = a2 * g2 + o3;
      for (y2 = v; y2 < m; y2++) {
    ...
    for (var r2 = t3.shape[0], o3 = t3.shape[1], a2 = t3.shape[2], i2 = t3.shape[3], s2 = o3 * e2, u2 = a2 * e2, c2 = i2 / (e2 * e2), l2 = this.readSync(t3.dataId), h2 = new Float32Array(r2 * s2 * u2 * c2), f2 = 0, d2 = 0; d2 < r2; ++d2)
      for (var p2 = 0; p2 < s2; ++p2)
        for (var v = Math.floor(p2 / e2), m = p2 % e2, g2 = 0; g2 < u2; ++g2)
          for (var y2 = Math.floor(g2 / e2), x2 = (m * e2 + g2 % e2) * c2, b2 = 0; b2 < c2; ++b2) {
    ...
    for (var i2 = t3.shape, s2 = i2[0], u2 = i2[1], c2 = i2[2], l2 = i2[3], h2 = e2.shape[0], f2 = r2[0], d2 = r2[1], p2 = dr([h2, f2, d2, l2], "float32"), v = this.readSync(e2.dataId), m = this.readSync(n2.dataId), g2 = this.readSync(t3.dataId), y2 = t3.strides, x2 = p2.strides, b2 = 0; b2 < h2; b2++) {
    ...
    for (var p2 = 0; p2 < a2; p2++) {
      ...
      for (var x2 = 0; x2 < o3; x2++)
        c2 ? d2.values[m * o3 + x2] += f2[p2 * o3 + x2] : d2.values[m * o3 + x2] = e2.rank === 0 ? f2[0] : f2[p2 * o3 + x2];
    }
...
for (var jh = 0, Xh = [{ kernelName: "NonMaxSuppressionV5", backendName: "cpu", kernelFunc: function(t2) {
  ...
  var s2 = i2.data.get(o2.dataId).values, u2 = i2.data.get(a2.dataId).values, c2 = function(t3, e3, n3, r3, o3, a3) {
    var i3 = Ro(t3, e3), s3 = i3.length, u3 = $(i3), c3 = B(o3, k(i3)), l3 = t3.length, h3 = e3.length, f2 = $(t3), d2 = $(e3), p2 = Co(t3, i3), v = Co(e3, i3);
    if (p2.length + v.length === 0)
      for (var m = 0; m < c3.length; ++m)
        c3[m] = a3(n3[m % n3.length], r3[m % r3.length]);
    else {
      var g2 = function(t4) {
...
for (var Jh = 0, Zh = [{ kernelName: "FromPixels", backendName: "webgl", kernelFunc: function(t2) {
  var e2 = t2.inputs, n2 = t2.backend, r2 = t2.attrs, o2 = e2.pixels, a2 = r2.numChannels, s2 = typeof HTMLVideoElement != "undefined" && o2 instanceof HTMLVideoElement, u2 = typeof HTMLImageElement != "undefined" && o2 instanceof HTMLImageElement, c2 = s2 ? [o2.videoWidth, o2.videoHeight] : [o2.width, o2.height], l2 = c2[0], h2 = c2[1], f2 = [h2, l2], d2 = [h2, l2, a2];
  (u2 || s2) && (Yh == null && (Yh = document.createElement("canvas").getContext("2d")), Yh.canvas.width = l2, Yh.canvas.height = h2, Yh.drawImage(o2, 0, 0, l2, h2), o2 = Yh.canvas);
...
var rf, of = function() {
  ...
  return t2.prototype.fetch = function(t3, e2) {
    return i().global.fetch != null ? i().global.fetch(t3, e2) : (rf == null && (rf = of()), rf(t3, e2));
  }, t2.prototype.now = function() {
...
function cf(t2, e2) {
  for (var n2 = {}, r2 = 0, o2 = function(e3) {
    ...
    if ("quantization" in e3) {
      ...
      var l2 = sf[c2.dtype], h2 = t2.slice(r2, r2 + s2 * l2), f2 = c2.dtype === "uint8" ? new Uint8Array(h2) : new Uint16Array(h2);
      if (a3 === "float32")
...
var hf = typeof Buffer != "undefined" && (typeof Blob == "undefined" || typeof atob == "undefined" || typeof btoa == "undefined");
function ff(t2) {
...
function vf(t2) {
  ...
  return { dateSaved: new Date(), modelTopologyType: "JSON", modelTopologyBytes: t2.modelTopology == null ? 0 : ff(JSON.stringify(t2.modelTopology)), weightSpecsBytes: t2.weightSpecs == null ? 0 : ff(JSON.stringify(t2.weightSpecs)), weightDataBytes: t2.weightData == null ? 0 : t2.weightData.byteLength };
}
var mf = function() {
  function t2() {
...
var If = function() {
  function t2(t3) {
    if (this.indexedDB = Ef(), t3 == null || !t3)
...
var Wf = function() {
  ...
  return t2.prototype.listModels = function() {
    ...
    return n(this, void 0, void 0, function() {
      ...
      return r(this, function(r2) {
        var o2;
        if (t3 = (o2 = t3).startsWith(Pf.URL_SCHEME) ? o2.slice(Pf.URL_SCHEME.length) : o2, e2 = Mf(t3), this.LS.getItem(e2.info) == null)
...
var Hf = function() {
  function t2(e2) {
    ...
    e2.startsWith(t2.URL_SCHEME) && (e2 = e2.slice(t2.URL_SCHEME.length)), e2 != null && e2.length !== 0 || (e2 = Uf), this.modelTopologyFileName = e2 + Vf, this.weightDataFileName = e2 + zf;
  }
  return t2.prototype.save = function(t3) {
    return n(this, void 0, void 0, function() {
      ...
      return r(this, function(r2) {
        switch (r2.label) {
          ...
          case 2:
            return r2.sent(), t3.weightData == null ? [3, 4] : ((s2 = this.weightDataAnchor == null ? document.createElement("a") : this.weightDataAnchor).download = this.weightDataFileName, s2.href = e2, [4, Gf(function() {
                ...
                u2.forEach(function(t4) {
                  ...
                  t4.paths.forEach(function(t5) {
                    ...
                    e3.onload = function(e4) {
                      ...
                      f2[o3] = n3, f2.indexOf(null) === -1 && r3({ modelTopology: s2, weightSpecs: l2, weightData: df(f2), format: i2.format, generatedBy: i2.generatedBy, convertedBy: i2.convertedBy, userDefinedMetadata: i2.userDefinedMetadata });
    ...
    return r(this, function(r2) {
      switch (r2.label) {
        ...
        case 4:
          ...
          }), l2 = 0.5, h2 = 1, e2.onProgress != null ? [3, 6] : [4, Promise.all(c2)];
        case 5:
...
function $f(t2) {
  return t2.match(Yf.URL_SCHEME_REGEX) != null;
}
...
var ed = Object.freeze({ browserFiles: function(t2) {
      ...
      switch (l2.label) {
        case 0:
          for (o2 = [], a2 = [], i2 = Array.isArray(t2) ? t2.map(function(t3) {
            ...
            if (l3.dtype !== "float32" && l3.dtype !== "int32" && l3.dtype !== "bool" && l3.dtype !== "string")
  ...
  return arguments.length === 1 ? t2.modelTopology != null || t2.weightSpecs != null ? new Zf(t2) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Zf({ modelTopology: t2 })) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Zf({ modelTopology: t2, weightSpecs: e2, weightData: n2, trainingConfig: r2 }));
...
Object.freeze({ confusionMatrix: rd });
var ad = An({ fromPixels_: function(t2, e2) {
  ...
  if (i2 ? s2 = t2.getContext("2d").getImageData(0, 0, h2, f2).data : r2 || n2 ? s2 = t2.data : (a2 || o2) && (nd == null && (nd = document.createElement("canvas").getContext("2d")), nd.canvas.width = h2, nd.canvas.height = f2, nd.drawImage(t2, 0, 0, h2, f2), s2 = nd.getImageData(0, 0, h2, f2).data), e2 === 4)
  ...
  return n(this, void 0, void 0, function() {
    var n2, o2, a2, i2, s2, u2, c2, l2, h2, f2, d2, p2, v, m, g2, y2, x2, b2, w2, C2, E2, R2, I2;
    return r(this, function(r2) {
      switch (r2.label) {
        case 0:
          if (n2 = mn(t2, "img", "toPixels"), t2 instanceof wt || (n2 = n2.toInt()), n2.rank !== 2 && n2.rank !== 3)
        ...
        case 2:
          if (h2 = r2.sent(), f2 = h2[0], d2 = h2[1], p2 = f2[0], v = d2[0], c2.dispose(), l2.dispose(), n2.dtype === "float32") {
            if (p2 < 0 || v > 1)
          ...
          for (m = n2.dtype === "float32" ? 255 : 1, g2 = new Uint8ClampedArray(i2 * a2 * 4), y2 = 0; y2 < a2 * i2; ++y2)
            x2 = void 0, b2 = void 0, w2 = void 0, C2 = void 0, s2 === 1 ? (x2 = u2[y2] * m, b2 = u2[y2] * m, w2 = u2[y2] * m, C2 = 255) : s2 === 3 ? (x2 = u2[3 * y2] * m, b2 = u2[3 * y2 + 1] * m, w2 = u2[3 * y2 + 2] * m, C2 = 255) : s2 === 4 && (x2 = u2[4 * y2] * m, b2 = u2[4 * y2 + 1] * m, w2 = u2[4 * y2 + 2] * m, C2 = u2[4 * y2 + 3] * m), g2[(E2 = 4 * y2) + 0] = Math.round(x2), g2[E2 + 1] = Math.round(b2), g2[E2 + 2] = Math.round(w2), g2[E2 + 3] = Math.round(C2);
          return e2 != null && (e2.width = i2, e2.height = a2, R2 = e2.getContext("2d"), I2 = new ImageData(g2, i2, a2), R2.putImageData(I2, 0, 0)), n2 !== t2 && n2.dispose(), [2, g2];
      }
    });
  });
...
Object.freeze({ Serializable: sd, SerializationMap: ud, registerClass: cd });
var hd = 1e-3, fd = 0.1;
function dd() {
  return Lt.backend.floatPrecision() === 32 ? hd : fd;
}
...
Object.freeze({ TEST_EPSILON_FLOAT16: fd, expectArraysClose: function(t2, e2, n2) {
  return n2 == null && (n2 = dd()), pd(t2, e2, function(t3, e3) {
    return vd(t3, e3, n2);
  });
...
Object.freeze({ gpgpu_util: Mi, webgl_util: Ge, forceHalfFloat: function() {
...
cd(kd);
typeof requestAnimationFrame != "undefined" ? requestAnimationFrame : typeof setImmediate != "undefined" ? setImmediate : function(t2) {
  return t2();
};
...
var FaceDetection = function(_super) {
...
var FaceLandmarks5 = function(_super) {
...
var FaceLandmarks68 = function(_super) {
...
var LabeledBox = function(_super) {
...
function createNodejsEnv() {
  ...
  var Image2 = global["Image"] || global["HTMLImageElement"];
...
function monkeyPatch(env2) {
  ...
  var _a2 = env2.Canvas, Canvas = _a2 === void 0 ? environment.Canvas : _a2, _b = env2.Image, Image2 = _b === void 0 ? environment.Image : _b;
  environment.Canvas = Canvas;
  environment.Image = Image2;
...
function isMediaLoaded(media) {
  var _a2 = env.getEnv(), Image2 = _a2.Image, Video = _a2.Video;
  return media instanceof Image2 && media.complete || media instanceof Video && media.readyState >= 3;
}
...
function createCanvasFromMedia(media, dims) {
  ...
  var canvas = createCanvas$1({ width, height });
...
function isMediaElement(input) {
  var _a2 = env.getEnv(), Image2 = _a2.Image, Canvas = _a2.Canvas, Video = _a2.Video;
  return input instanceof Image2 || input instanceof Canvas || input instanceof Video;
}
function imageToSquare(input, inputSize, centerImage) {
  if (centerImage === void 0) {
    centerImage = false;
  }
  var _a2 = env.getEnv(), Image2 = _a2.Image, Canvas = _a2.Canvas;
  if (!(input instanceof Image2 || input instanceof Canvas)) {
      ...
      switch (_b.label) {
        ...
        case 5:
          ...
          return [2, boxes.map(function(_a3) {
            ...
            var faceImg = createCanvas$1({ width, height });
...
var FaceFeatureExtractor = function(_super) {
...
var FaceProcessor = function(_super) {
...
var FaceExpressionNet = function(_super) {
...
var AgeGenderNet = function(_super) {
...
var FaceLandmark68NetBase = function(_super) {
...
var FaceLandmark68Net = function(_super) {
...
var TinyFaceFeatureExtractor = function(_super) {
...
var FaceLandmark68TinyNet = function(_super) {
...
var FaceRecognitionNet = function(_super) {
...
var SsdMobilenetv1 = function(_super) {
...
var TinyYolov2Base = function(_super) {
...
var TinyYolov2 = function(_super) {
...
var TinyFaceDetectorOptions = function(_super) {
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          bitmaps.forEach(function(bmp) {
            var patch = createCanvas$1({ width, height });
...
var TinyFaceDetector = function(_super) {
...
var PredictFaceExpressionsTaskBase = function(_super) {
...
var PredictAllFaceExpressionsTask = function(_super) {
...
var PredictSingleFaceExpressionsTask = function(_super) {
...
var PredictAllFaceExpressionsWithFaceAlignmentTask = function(_super) {
...
var PredictSingleFaceExpressionsWithFaceAlignmentTask = function(_super) {
...
var PredictAgeAndGenderTaskBase = function(_super) {
...
var PredictAllAgeAndGenderTask = function(_super) {
...
var PredictSingleAgeAndGenderTask = function(_super) {
...
var PredictAllAgeAndGenderWithFaceAlignmentTask = function(_super) {
...
var PredictSingleAgeAndGenderWithFaceAlignmentTask = function(_super) {
...
var ComputeFaceDescriptorsTaskBase = function(_super) {
...
var ComputeAllFaceDescriptorsTask = function(_super) {
...
var ComputeSingleFaceDescriptorTask = function(_super) {
...
var DetectFacesTaskBase = function(_super) {
...
var DetectAllFacesTask = function(_super) {
...
var DetectSingleFaceTask = function(_super) {
...
class FaceDetector {
  ...
  _createHelperCanvas() {
    const canvas = createCanvasFromMedia(this._videoInput);
    canvas.style.position = "absolute";
    matchDimensions(canvas, this._getVideoDisplaySize());
    document.body.append(canvas);
    return canvas;
  }
  async _drawDetections(detectData) {
    this._canvas.getContext("2d").clearRect(0, 0, this._canvas.width, this._canvas.height);
    drawDetections(this._canvas, resizeResults(detectData, this._getVideoDisplaySize()));
  }
  async _loadModels() {
    const modelsToLoaded = [];
    if (!nets.tinyFaceDetector.isLoaded) {
      modelsToLoaded.push(nets.tinyFaceDetector.loadFromUri(this._modelsUrl));
    }
...
function createVideo(options = {}) {
  ...
  videoElement.autoplay = (_a2 = options.autoplay) != null ? _a2 : true;
...
async function resizeImgBasedAspectRatio(imgOrBase64, options = {}) {
  ...
  return await resizeImg(img, {
    quality: (_a2 = options.quality) != null ? _a2 : 0.85,
...
class CameraController {
  ...
  async _createMediaStream() {
    ...
    if (mediaStream) {
      ...
      mediaStreamTrack.onended = (ev) => {
        var _a2, _b;
        (_b = (_a2 = this._options).onRecordingInterrupted) == null ? void 0 : _b.call(_a2);
        this.stop();
      };
    }
    return mediaStream;
  ...
  _createMediaStreamErrorHandler(error) {
    ...
    switch (error.name) {
      case "NotAllowedError":
        {
          (_b = (_a2 = this._options).onDevicePermissionDenied) == null ? void 0 : _b.call(_a2);
          this.stop();
        }
        break;
      case "NotFoundError":
        {
          (_d = (_c2 = this._options).onDeviceNotAvailable) == null ? void 0 : _d.call(_c2);
          this.stop();
        }
        break;
  ...
  stop() {
    ...
    this._destroy();
    if (isActive) {
      (_b = (_a2 = this._options).onRecordingEnd) == null ? void 0 : _b.call(_a2);
    }
  }
  async start(cb) {
    var _a2, _b, _c2, _d;
  ...
  async getScreenshotAsBase64(cb, options = {}) {
    var _a2, _b;
    const base64 = (_b = (_a2 = await this.getScreenshotAsImg(void 0, options)) == null ? void 0 : _a2.src) != null ? _b : null;
    cb == null ? void 0 : cb(base64);
    return base64;
  }
  async getScreenshotAsImg(cb, options = {}) {
    ...
    const _options = __spreadValues({
      useAspectRatio: (_a2 = this._screenshotOptions) == null ? void 0 : _a2.useAspectRatio,
      width: (_c2 = (_b = this._screenshotOptions) == null ? void 0 : _b.width) != null ? _c2 : this._videoBaseElement.videoWidth,
      height: (_e2 = (_d = this._screenshotOptions) == null ? void 0 : _d.height) != null ? _e2 : this._videoBaseElement.videoHeight
    }, options);
    const img = _options.useAspectRatio ? await resizeImgBasedAspectRatio(videoScreenshotBase64, _options) : await resizeImg(videoScreenshotBase64, _options);
    cb == null ? void 0 : cb(img);
    return img;
  }
